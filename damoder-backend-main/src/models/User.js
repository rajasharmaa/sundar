...
const userSchema = new Schema({
  ...
  // ✅ M2-1 FIX: Removed manual createdAt/updatedAt field definitions.
  // The { timestamps: true } option in the schema config below already handles these automatically.
  // Having both caused Mongoose to define them twice, making updatedAt unreliable.
