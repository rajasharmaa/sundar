...
async function initializeQueues() {
    try {
        ...
        queues.emailQueue = await queueManager.initQueue(QUEUE_CONFIG.email.name, QUEUE_CONFIG.email.options);
        queues.notificationQueue = await queueManager.initQueue(QUEUE_CONFIG.notification.name, QUEUE_CONFIG.notification.options);
        queues.heavyDbQueue = await queueManager.initQueue(QUEUE_CONFIG.heavyDb.name, QUEUE_CONFIG.heavyDb.options);
