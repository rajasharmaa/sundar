...
const getDashboardAnalytics = async (req, res) => {
  try {
    ...
    return sendErrorResponse(
      res,
      createError.internalServerError('Failed to fetch analytics'),
      req.requestId
    );
  }
};
...
const getProductAnalytics = async (req, res) => {
  try {
    ...
    return sendErrorResponse(
      res,
      createError.internalServerError('Failed to fetch product analytics'),
      req.requestId
    );
  }
};
...
const getViewAnalytics = async (req, res) => {
  try {
    ...
    return sendErrorResponse(
      res,
      createError.internalServerError('Failed to fetch view analytics'),
      req.requestId
    );
  }
};
...
const getInquiryAnalytics = async (req, res) => {
  try {
    ...
    return sendErrorResponse(
      res,
      createError.internalServerError('Failed to fetch inquiry analytics'),
      req.requestId
    );
  }
};
...
const getConversionRate = async (req, res) => {
  try {
    ...
    return sendErrorResponse(
      res,
      createError.internalServerError('Failed to fetch conversion rate'),
      req.requestId
    );
  }
};
...
const trackProductView = async (req, res) => {
  try {
    ...
    if (!result.success) {
      return sendErrorResponse(
        res,
        createError.badRequest(result.error),
        req.requestId
      );
    }
    ...
    return sendErrorResponse(
      res,
      createError.internalServerError('Failed to track view'),
      req.requestId
    );
  }
};
...
const getSearchAnalytics = async (req, res) => {
  try {
    ...
    return sendErrorResponse(
      res,
      createError.internalServerError('Failed to fetch search analytics'),
      req.requestId
    );
  }
};
