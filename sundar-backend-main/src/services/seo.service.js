...
const config = {
  siteName: 'Sundar Corporation',
  siteUrl: process.env.SITE_URL || 'https://sundarcorporation.com',
  twitterHandle: '@sundarcorporation',
  defaultTitle: 'Premium Packaging Products - Sundar Corporation',
  defaultDescription: 'Your trusted partner for high-quality industrial products. Browse our comprehensive catalog of bags, bags, sacks, and accessories.'
};
...
const generateCategoryMeta = (category, productCount = 0) => {
  ...
  const title = category.metaTitle || `${categoryName} - Packaging Products | ${config.siteName}`;
