...
const emailTemplates = {
  'forgot-password': (data) => `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
      ...
      <p>You requested a password reset for your Sundar Corporation account. Click the button below to reset it:</p>
      ...
      <p style="color: #999; font-size: 12px;">© ${new Date().getFullYear()} Sundar Corporation. Packaging Solutions You Can Trust.</p>
    </div>
  `,
  ...
  'welcome': (data) => `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
      <h2 style="color: #333;">Welcome to Sundar Corporation!</h2>
      <p>Hello ${data.name},</p>
      <p>Thank you for registering with Sundar Corporation. We're excited to have you as part of our community of industrial suppliers.</p>
