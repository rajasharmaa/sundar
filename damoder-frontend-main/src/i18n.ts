  ...
  en: {
    translation: {
      ...
      "whatsapp": {
        ...
        "hiMessage": "Hello Damodar Traders, my name is {{name}}. I would like to order {{quantity}} piece(s) of {{product}}. Delivery Address: {{remarks}}."
      },
      "home": {
        ...
        "establishedDesc": "Established in {{year}}, {{name}} has grown to become a trusted leader in industrial pipe fittings and solutions.",
        ...
        "heroText1": "Industrial Excellence in Every Pipe",
        "heroText2": "Quality Pipe Fittings Since 2011",
        ...
        "ceoQuote": "Damodar Traders has been our trusted supplier for over 5 years. Their product quality and service reliability are unmatched in the industry."
      }
    }
  },
  hi: {
