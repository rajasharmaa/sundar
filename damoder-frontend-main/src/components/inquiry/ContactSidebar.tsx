        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-10">
          {[
            ...
            <div key={i} className="group">
              <p className="text-3xl font-black text-slate-900 tracking-tighter group-hover:text-blue-600 transition-colors">
                {stat.value}
              </p>
              <div className="mt-1">
        ...
        <div className="space-y-6 relative z-10">
          {[
            ...
            <div key={i} className="flex items-start gap-4 group">
              <div className="w-10 h-10 rounded-2xl bg-white/5 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 text-slate-400">
                {item.icon}
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-1">{item.label}</p>
                {item.href ? (
                  <a href={item.href} className="text-sm font-bold hover:text-blue-400 transition-colors flex items-center gap-2">
                    {item.value}
