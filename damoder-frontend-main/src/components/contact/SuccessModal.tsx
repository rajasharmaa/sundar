        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="bg-slate-50 border border-slate-150 rounded-xl p-4 mb-6">
              <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Your Sourcing Ticket</p>
              <p className="text-base font-black text-blue-600 mt-1">{ticketNumber}</p>
            ...
            <button
              onClick={onClose}
              type="button"
              className="w-full py-4 bg-slate-900 text-white font-black uppercase tracking-widest text-xs rounded-xl hover:bg-blue-600 transition-all shadow-xl"
            >
              Confirm & Return
            </button>
          </motion.div>
