      ...
      <div className="bg-white rounded-2xl p-4 shadow-2xl shadow-slate-200 border border-slate-100">
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-1 p-4">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <p className="text-slate-800 font-bold text-xs">37 Ellora Plaza, Maharani Road, Indore, MP 452007</p>
              </div>
              <a
                href="https://www.google.com/maps?q=37+Ellora+Plaza,+Maharani+Road,+Indore,+MP+452007"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full py-3 bg-white border-2 border-slate-100 text-slate-900 font-black uppercase tracking-widest text-[10px] rounded-xl hover:border-blue-600 hover:text-blue-600 transition-all flex items-center justify-center gap-1.5"
              >
                Open in Maps
          ...
          <div className="lg:col-span-2 h-[350px] rounded-xl overflow-hidden border border-slate-100">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3680.169123869919!2d75.856994!3d22.717462!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3962fd17b07c89f5%3A0x5a1f26e2e505cc28!2sMaharani%20Rd%2C%20Indore%2C%20Madhya%20Pradesh%20452007!5e0!3m2!1sen!2sin!4v1718428800000"
              width="100%"
              height="100%"
              style={{ border: 0 }}
