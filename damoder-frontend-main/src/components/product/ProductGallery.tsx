  ...
  return (
    <div className="w-full relative bg-white rounded-3xl shadow-2xl border border-slate-200/70 overflow-hidden transition-all duration-500 hover:shadow-cyan-200/30">
      ...
      <div className="flex gap-3 p-4 bg-slate-50 border-t border-slate-200/70 overflow-x-auto scrollbar-hide">
        ...
        <button
          onClick={toggleInteractiveView}
          className={`w-16 h-16 sm:w-20 sm:h-20 rounded-2xl border-2 flex-shrink-0 flex items-center justify-center transition-all bg-white shadow-sm ${
            isInteractiveView
              ? 'border-blue-500 bg-blue-50/50 scale-105 ring-2 ring-blue-500/20'
              : 'border-slate-200 hover:border-blue-400'
          }`}
        >
          <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center ${isInteractiveView ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-600'}`}>
        ...
        {allImages.map((img, idx) => (
          <button
            ...
            className={`w-16 h-16 sm:w-20 sm:h-20 flex-shrink-0 rounded-2xl border-2 overflow-hidden transition-all bg-white shadow-sm ${
              idx === currentImageIndex && !isInteractiveView
                ? 'border-blue-600 scale-105 ring-2 ring-blue-600/20'
                : 'border-slate-200 hover:border-blue-400'
            }`}
          >
            <img
