...
export function InquiryForm({ productId, productName, selectedSize, productCode, trigger }: InquiryFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (productCode) {
        inquiryData.productCode = productCode;
      }

      // Use user's email if logged in and no email in form
      if (user?.email && !formData.email) {
        inquiryData.email = user.email;
      }

      // Add subject - ensure it meets minimum length requirement (5 chars)
  ...
  return (
    <>
      ...
      <div onClick={() => setOpen(true)}>
        {trigger || (
          <Button className="gap-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-semibold shadow-md hover:shadow-lg transition-all duration-300">
            ...
            <>
              ...
              >
                <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg sm:max-w-xl my-4 sm:my-8 overflow-hidden max-h-[calc(100vh-2rem)] sm:max-h-[calc(100vh-4rem)] overflow-y-auto animate-in zoom-in-95 duration-200">
                  {/* Header */}
                  <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border-b border-gray-200 p-4 sm:p-5">
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-3 flex-1">
                        <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-lg flex items-center justify-center shadow-md flex-shrink-0">
                  ...
                  <form onSubmit={handleSubmit} className="p-4 sm:p-5">
                    <div className="space-y-4">
                      ...
                      <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-lg p-3">
                        <p className="text-xs text-blue-700 font-semibold uppercase tracking-wide mb-1">Product Details</p>
                        <p className="text-sm font-bold text-blue-900 truncate">{productName}</p>
                        {selectedSize && (
                        ...
                        <div className="grid sm:grid-cols-2 gap-3">
                          ...
                          <div className="space-y-1.5">
                            ...
                            <Input
                              ...
                              disabled={isSubmitting}
                              className="w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all duration-200 text-sm"
                              required
                            />
                          </div>
                          ...
                          <div className="grid sm:grid-cols-2 gap-2">
                            <label className={`flex items-center justify-center p-2.5 border-2 rounded-lg cursor-pointer transition-all duration-200 ${formData.priceType === '100'
                              ...
                              <div className="text-center">
                                <div className="font-bold text-blue-700 text-xs">Standard Price</div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <Textarea
                            ...
                            rows={4}
                            disabled={isSubmitting}
                            className="w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all duration-200 resize-none text-sm"
                            required
                          />
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 pt-3 border-t border-gray-200">
                        <Button
                          type="submit"
                          className="flex-1 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-bold py-2.5 px-4 rounded-md shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-md min-h-[40px] text-sm"
                          disabled={isSubmitting}
                        >
                          {isSubmitting ? (
