                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      <Link
                        ...
                        className="flex-1 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-cyan-700 transition-all text-center"
                      >
                        View Details
                      </Link>
                      <button
                        onClick={handleInquiry}
                        className="flex-1 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all flex items-center justify-center gap-2"
                      >
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        className={`flex-1 py-3 border-2 font-semibold rounded-xl transition-all flex items-center justify-center gap-2 ${isInWishlist(product.id)
