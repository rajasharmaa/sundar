    ...
    <div className="space-y-5">
      ...
      {pwaInstallable && (
        <button
          ...
          className={`w-full flex items-center justify-center gap-2 py-3 px-4 rounded-2xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg hover:shadow-xl transition-all ${
        ...
        >
          ...
          <div className="text-left flex-1">
            ...
            <div className="text-[9px] text-blue-100 font-medium">
  ...
  return (
    <div ref={widgetRef} className="fixed bottom-28 lg:bottom-6 left-6 z-[999] flex flex-col items-start">
      ...
      <button
        ...
        className={`w-16 h-16 rounded-full bg-gradient-to-br from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white flex items-center justify-center shadow-2xl transition-all duration-300 hover:scale-110 relative group ${
      ...
      >
        ...
        {/* Tooltip */}
        <div className="absolute left-full ml-4 px-3 py-1.5 bg-white text-gray-800 text-xs font-bold rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap border border-blue-50">
