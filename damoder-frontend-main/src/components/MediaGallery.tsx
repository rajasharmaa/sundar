                    ...
                    <div className="h-full bg-white rounded-3xl sm:rounded-[2.5rem] overflow-hidden border border-gray-100 shadow-[0_10px_40px_rgba(0,0,0,0.02)] hover:shadow-[0_30px_70px_rgba(0,0,0,0.12)] transition-all duration-700 flex flex-col relative">
                      ...
                      <div className="relative aspect-square sm:aspect-[4/5] overflow-hidden bg-gray-50 flex items-center justify-center p-4">
                        ...
                        <div className="absolute top-6 left-6 flex flex-col gap-2">
                           <div className="px-4 py-1.5 bg-white/90 backdrop-blur-md rounded-full text-[10px] font-black uppercase tracking-widest text-blue-600 shadow-sm border border-white">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-blue-900/80 via-blue-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 p-8 flex flex-col justify-end">
                           <div className="flex items-center justify-between">
                             ...
                             <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-blue-900 shadow-xl transform rotate-12 group-hover:rotate-0 transition-all duration-500">
