      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 xs:py-3.5 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all hover:border-gray-400 min-h-[48px] text-sm xs:text-base"
      ...
      <div>
        <div className="flex justify-between items-center mb-2">
          ...
          <Link
            ...
            className="text-xs xs:text-sm text-blue-600 hover:text-blue-800 transition-colors touch-target"
          >
            Forgot Password?
          </Link>
        </div>
        <div className="relative">
          ...
          <input
            ...
            required
            disabled={isLoading || isCheckingServer}
            className="w-full pl-10 pr-12 py-3 xs:py-3.5 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all hover:border-gray-400 min-h-[48px] text-sm xs:text-base"
