...
export const ScrollFixDemo = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[200] bg-white rounded-lg shadow-2xl p-4 border-2 border-blue-500 max-w-sm">
        ...
        <div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-3 py-1.5 bg-purple-600 text-white rounded hover:bg-purple-700 text-xs"
            >
              Scroll to S1
            </button>
            <button
...
export const TestSections = () => {
  return (
    <div className="space-y-0">
      <section id="test-section-1" className="min-h-screen py-20 bg-blue-50 border-b-4 border-blue-200">
      ...
      <section id="test-section-3" className="min-h-screen py-20 bg-purple-50">
        <div className="max-w-4xl mx-auto px-6">
