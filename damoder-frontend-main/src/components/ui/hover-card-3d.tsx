      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {onQuickView && (
            <button
              onClick={onQuickView}
              className="mt-4 w-full py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 btn-press"
            >
              Quick View
            </button>
          )}
