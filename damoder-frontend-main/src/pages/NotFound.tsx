...
const NotFound = () => {
  ...
  return (
    <>
      <Helmet>
        <title>404 - Page Not Found | Damodar Traders</title>
        <meta name="description" content="The page you are looking for does not exist. Return to Damodar Traders home page." />
      </Helmet>
      ...
      <main className="relative z-10 min-h-[75vh] flex items-center justify-center pt-28 pb-20 px-6">
        ...
        <div className="max-w-xl w-full">
          <motion.div
            ...
            className="bg-white/95 backdrop-blur-xl border border-blue-100 rounded-[3rem] p-8 md:p-12 shadow-2xl text-center"
          >
            ...
            <div className="flex flex-col gap-4">
              <Link
                to="/"
                className="w-full py-4 bg-blue-600 text-white font-black rounded-2xl hover:bg-blue-700 transition-all duration-300 shadow-xl hover:shadow-blue-200 flex items-center justify-center gap-3 active:scale-[0.98] uppercase tracking-wider text-xs"
              >
                <Home size={16} />
