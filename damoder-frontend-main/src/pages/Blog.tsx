...
const Blog = () => {
   ...
   const categories = ['All', 'Industry News', 'Technical Guides', 'Project Highlights', 'Maintenance'];

   const posts = [
      {
         id: 1,
         title: 'Choosing the Right Pipe Material for High-Pressure Systems',
         excerpt: 'A comprehensive guide on selecting between Carbon Steel and Stainless Steel for demanding industrial applications.',
         category: 'Technical Guides',
         date: 'May 12, 2024',
         author: 'Damodar Sharma',
         readTime: '8 min read',
         image: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&q=80&w=800'
      },
      {
         id: 2,
         title: 'Upcoming Trends in Industrial Valve Automation for 2024',
         excerpt: 'How smart controls and IoT are revolutionizing flow management in modern manufacturing plants.',
      ...
      {
         id: 3,
         title: 'Maintenance Best Practices for Industrial Pipe Fittings',
         excerpt: 'Prevent leaks and extend the life of your piping systems with these simple but effective maintenance steps.',
         category: 'Maintenance',
         date: 'April 28, 2024',
         author: 'Quality Dept',
         readTime: '10 min read',
         image: 'https://images.unsplash.com/photo-1531287702847-c670e9b9787d?auto=format&fit=crop&q=80&w=800'
      }
   ];
   ...
   return (
      <>
         <Helmet>
            <title>Blog & Insights - Damodar Traders | Industrial News</title>
            <meta name="description" content="Stay updated with the latest industrial news, technical guides, and maintenance tips from Damodar Traders." />
         </Helmet>
            ...
            <section className="max-w-7xl mx-auto px-6 mb-20">
               ...
               >
                  ...
                  <p className="text-xl text-gray-600 font-medium max-w-2xl mx-auto">
                     Expert perspectives on piping systems, valve technology, and industrial engineering trends.
                  </p>
               </motion.div>
                     ...
                     <div className="flex flex-col lg:flex-row">
                        ...
                        <div className="lg:w-1/2 p-12 lg:p-20 flex flex-col justify-center">
                           ...
                           <h2 className="text-3xl md:text-5xl font-black text-gray-900 leading-none tracking-tighter uppercase mb-6 group-hover:text-blue-600 transition-colors">
                              The Future of Carbon Steel in Sustainable Industrial Infrastructure
                           </h2>
