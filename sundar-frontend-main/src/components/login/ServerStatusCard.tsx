    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="mt-2 w-full bg-green-200 rounded-full h-2 overflow-hidden relative">
            {progress > 0 ? (
              <motion.div
                className="bg-green-600 h-2 rounded-full absolute left-0 top-0"
                initial={{ width: 0 }}
              ...
              <motion.div
                className="bg-green-600 h-2 rounded-full absolute top-0"
                animate={{
                  left: ['-50%', '100%'],
                }}
                transition={{
