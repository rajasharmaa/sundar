...
const AnimatedButton = forwardRef<HTMLButtonElement, AnimatedButtonProps>(
  ({
    ...
    const buttonClasses = cn(
      'inline-flex items-center justify-center gap-2 font-medium transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none btn-press-effect',
