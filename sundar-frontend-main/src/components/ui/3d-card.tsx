    ...
    return (
      ...
      >
        ...
        <div className="relative aspect-video overflow-hidden">
          ...
          {/* Badge */}
          {badge && (
            <div className="absolute top-3 left-3 bg-gradient-to-r from-green-500 -green- text-white px-3 py-1 rounded-full text-xs font-medium shadow-lg">
              {badge}
            </div>
          )}
    ...
    const content = (
      ...
      >
        <div className="p-6 h-full flex flex-col">
          {/* Icon */}
          <div className="mb-4">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-green-500 -green- text-white shadow-lg">
              {icon}
            </div>
