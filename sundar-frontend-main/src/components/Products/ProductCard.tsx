      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 pt-3 border-t border-gray-200">
          <Link
            ...
            className="flex-1 px-4 py-2 bg-gradient-to-r from-green-600 to-cyan-600 text-white rounded-lg font-medium text-sm hover:from-green-700 hover:to-cyan-700 transition-all flex items-center justify-center gap-2"
          >
            View Details
