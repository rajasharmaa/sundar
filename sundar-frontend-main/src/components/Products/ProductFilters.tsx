        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 xs:pl-10 pr-9 xs:pr-10 py-2.5 xs:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-base sm:text-sm min-h-[44px] touch-target"
              disabled={isLoading}
            />
            {searchQuery && (
              <button
        ...
        <div className="mt-3 xs:mt-4 pt-3 xs:pt-4 border-t border-gray-200 animate-fadeIn">
          ...
          <div className="grid grid-cols-1 gap-3 xs:gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-base sm:text-sm min-h-[44px]"
                disabled={isLoading}
              />
            </div>
          ...
          {(filters.minPrice !== undefined || filters.maxPrice !== undefined || filters.inStock || filters.featured) && (
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              {filters.featured && (
                <span className="inline-flex items-center gap-1 px-3 py-1 -green- -green- rounded-full text-sm">
                  Featured
                  <button
                    onClick={() => {
