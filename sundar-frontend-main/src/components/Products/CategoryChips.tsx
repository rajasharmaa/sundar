      ...
      <div className="flex gap-2 sm:gap-3 min-w-max">
        ...
        <button
          ...
          className={`flex-shrink-0 flex items-center gap-2 px-4 py-2.5 xs:py-3 rounded-xl font-semibold transition-all duration-200 border-2 min-h-[44px] touch-manipulation active:scale-95 ${selectedCategory === 'all'
              ? 'bg-gradient-to-r from-green-600 to-cyan-600 text-white border-transparent shadow-md'
        ...
        {/* Category Chips */}
        {[
          { value: 'bags', label: 'Bags', icon: Icons.Layers },
          { value: 'bags', label: 'Bags', icon: Icons.Wrench },
          { value: 'sacks', label: 'Sacks', icon: Icons.Filter },
