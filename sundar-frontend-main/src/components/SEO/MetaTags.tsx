...
const SITE_NAME = 'Sundar Corporation';
const BASE_URL = 'https://Sundar CorporationCorporation.com';
const DEFAULT_IMAGE = '/og-image.jpg';
const TWITTER_HANDLE = '@Sundar CorporationCorporation';
...
export const SEO: React.FC<SEOProps> = ({
  title,
  description = 'Premium industrial products for superior performance and durability. Browse our comprehensive catalog of bags, bags, sacks, and accessories.',
  canonical,
  image = DEFAULT_IMAGE,
  type = 'website',
  keywords,
