...
export function ContactForm({ onSuccess }: ContactFormProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl shadow-slate-200 border border-slate-150 overflow-hidden relative">
      <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-green-600 to-cyan-500" />
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-slate-50 border rounded-xl focus:border-green-600 focus:bg-white outline-none transition-all font-semibold text-slate-800 text-base sm:text-sm shadow-inner ${formErrors.name ? 'border-rose-500' : 'border-slate-100'
                    }`}
                />
                {formErrors.name && (
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-slate-50 border rounded-xl focus:border-green-600 focus:bg-white outline-none transition-all font-semibold text-slate-800 text-base sm:text-sm shadow-inner ${formErrors.email ? 'border-rose-500' : 'border-slate-100'
                    }`}
                />
                {formErrors.email && (
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-slate-50 border rounded-xl focus:border-green-600 focus:bg-white outline-none transition-all font-semibold text-slate-800 text-base sm:text-sm shadow-inner ${formErrors.phone ? 'border-rose-500' : 'border-slate-100'
                    }`}
                />
                {formErrors.phone && (
              ...
              <div className="space-y-1">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:border-green-600 focus:bg-white outline-none transition-all font-semibold text-slate-850 text-base sm:text-sm shadow-inner"
                >
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-slate-50 border rounded-xl focus:border-green-600 focus:bg-white outline-none transition-all font-semibold text-slate-800 text-base sm:text-sm shadow-inner ${formErrors.companyName ? 'border-rose-500' : 'border-slate-100'
                    }`}
                />
                  ...
                  {['Standard Pricing', 'Bulk Order Pricing'].map((type) => {
                    ...
                    return (
                      <div
                        ...
                        className={`cursor-pointer p-4 rounded-xl border-2 transition-all flex items-center justify-between shadow-sm ${selected
                            ? isBulk
                      ...
                      >
                        ...
                        {selected && (
                          <CheckCircle2 size={16} className={isBulk ? 'text-emerald-600' : 'text-green-600'} />
                        )}
                      </div>
                    );
                  })}
              ...
              <div className="space-y-1 md:col-span-2">
                ...
                <div className="border-2 border-dashed border-slate-200 rounded-xl p-4 text-center hover:border-green-500 transition-colors bg-slate-50/50">
                  <input
                    type="file"
                    id="file-upload"
                  ...
                  {attachedFile ? (
                    <div className="flex items-center justify-between bg-white border border-slate-150 p-2.5 rounded-lg max-w-sm mx-auto shadow-sm">
                      <div className="flex items-center gap-2 overflow-hidden pr-2">
                        <FileText className="text-green-500 flex-shrink-0" size={18} />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                onChange={handleChange}
                maxLength={1000}
                placeholder="Provide product codes, custom sizing bounds, materials (PP/BOPP), and estimated volume..."
                className={`w-full px-4 py-3 bg-slate-50 border rounded-xl focus:border-green-600 focus:bg-white outline-none transition-all font-semibold text-slate-800 text-base sm:text-sm resize-none shadow-inner h-36 ${formErrors.message ? 'border-rose-500' : 'border-slate-100'
                  }`}
              ></textarea>
            ...
            <div className="relative border border-slate-100 p-3 rounded-xl bg-slate-50/50">
              ...
              <button
                ...
                className="absolute right-14 top-3 text-[9px] font-bold uppercase text-slate-400 hover:text-green-600"
              >
                Reset
              </button>
            </div>
        ...
        <div className="flex gap-3 pt-4 border-t border-slate-100 mt-6">
          ...
          {step < 3 ? (
            <button
              ...
              className="flex-1 py-3.5 bg-green-600 hover:bg-green-700 text-white font-black uppercase tracking-widest text-xs rounded-xl transition-all"
            >
              Next Step
            </button>
          ) : (
            <button
              ...
              type="submit"
              className="flex-1 py-3.5 bg-gradient-to-r from-green-600 to-cyan-600 hover:from-green-700 hover:to-cyan-700 text-white font-black uppercase tracking-widest text-xs rounded-xl transition-all shadow-lg disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
