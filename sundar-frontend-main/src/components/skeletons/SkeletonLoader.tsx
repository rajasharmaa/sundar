        ...
        <div className="text-center">
          ...
          {showProgress && (
            <div className="mt-4 w-48 bg-gray-200 rounded-full h-2.5">
              <div 
                className="bg-gradient-to-r from-green-500 to-cyan-500 h-2.5 rounded-full transition-all duration-500 ease-out" 
...
export const HeroSkeleton = () => (
  <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
    <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 -green- rounded-full blur-3xl"></div>
    </div>
