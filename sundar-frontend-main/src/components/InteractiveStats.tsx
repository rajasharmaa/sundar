...
const InteractiveStats = ({
  stats = [
    { icon: Users, value: 1500, label: 'Happy Clients', suffix: '+', duration: 2.5, color: 'text-green-600', gradient: 'from-green-500 to-cyan-500' },
    { icon: Package, value: 5000, label: 'Products', suffix: '+', duration: 3, color: 'text-green-600', gradient: 'from-green-500 to-emerald-500' },
    { icon: Clock, value: 12, label: 'Years Experience', suffix: '+', duration: 2, color: '-green-', gradient: '-green- to-pink-500' },
  ...
  const renderStatCard = (stat: StatItem, index: number) => (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        {/* Animated Number */}
        <div className="mb-2">
          <div className="text-4xl md:text-5xl font-bold bg-gradient-to-br from-gray-900 to-gray-700 bg-clip-text text-transparent group-hover:from-green-600 group-hover:to-cyan-600 transition-all duration-300">
            {animated && isVisible ? (
              <CountUp
                start={0}
                end={stat.value}
      ...
      <div className="absolute -bottom-10 -right-10 w-20 h-20 bg-gradient-to-br from-green-500/20 to-cyan-500/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500 group-hover:scale-150" />
      <div className="absolute -top-10 -left-10 w-20 h-20 bg-gradient-to-br -green- to-pink-500/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500 group-hover:scale-150 delay-150" />
    </motion.div>
  );
        ...
        {stats.map((stat, index) => (
          <motion.div
            ...
            className={`p-6 rounded-2xl cursor-pointer transition-all duration-300 ${activeStat === index
                ? 'bg-gradient-to-r from-green-50 to-cyan-50 border-2 border-green-200 shadow-lg'
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className={`w-3 h-3 rounded-full ${activeStat === index ? 'bg-green-500' : 'bg-gray-300'}`} />
            </div>
          </motion.div>
        ))}
      </div>
