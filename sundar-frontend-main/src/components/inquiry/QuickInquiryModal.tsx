          ...
          <div className="fixed inset-0 flex items-end sm:items-center justify-center z-[101] pointer-events-none px-4 sm:px-0">
            ...
            >
              ...
              <div className="relative bg-gradient-to-r from-slate-900 to-slate-800 px-6 py-6 overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-green-500/20 rounded-full blur-2xl -translate-y-1/2 translate-x-1/4 pointer-events-none" />
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    {productName && (
                      <div className="flex items-start gap-3 p-4 bg-green-50/50 border border-green-100 rounded-xl">
                        ...
                        <div>
                          <p className="text-xs font-bold uppercase tracking-wider text-green-600 mb-0.5">Inquiring About</p>
                    ...
                    <div>
                      ...
                      <div className="relative group">
                        <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                          <User className="w-5 h-5 text-slate-400 group-focus-within:text-green-500 transition-colors" />
                        </div>
                        <input
                          type="text"
                          id="name"
                          ...
                          required
                          className="w-full pl-11 pr-4 py-3 bg-slate-50 hover:bg-slate-100/50 border border-slate-200 focus:bg-white focus:border-green-500 focus:ring-4 focus:ring-green-500/10 rounded-xl outline-none transition-all duration-200 font-medium text-slate-900 text-base sm:text-sm placeholder:text-slate-400"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          <input
                            ...
                            onChange={handleInputChange}
                            required
                            className="w-full px-4 py-3 bg-slate-50 hover:bg-slate-100/50 border border-slate-200 focus:bg-white focus:border-green-500 focus:ring-4 focus:ring-green-500/10 rounded-xl outline-none transition-all duration-200 font-medium text-slate-900 text-base sm:text-sm placeholder:text-slate-400"
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                            <Phone className="w-5 h-5 text-slate-400 group-focus-within:text-green-500 transition-colors" />
                          </div>
                          <input
                            type="tel"
                            id="phone"
                    ...
                    <div>
                      ...
                      <div className="relative group">
                        <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                          <Building2 className="w-5 h-5 text-slate-400 group-focus-within:text-green-500 transition-colors" />
                        </div>
                        <input
                          type="text"
                          id="company"
                    ...
                    <div>
                      ...
                      <div className="relative group">
                        <textarea
                          ...
                          onChange={handleInputChange}
                          rows={3}
                          className="w-full px-4 py-3 bg-slate-50 hover:bg-slate-100/50 border border-slate-200 focus:bg-white focus:border-green-500 focus:ring-4 focus:ring-green-500/10 rounded-xl outline-none transition-all duration-200 resize-none font-medium text-slate-900 text-base sm:text-sm placeholder:text-slate-400"
                    ...
                    <button
                      ...
                      className="w-full py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg shadow-green-600/20 hover:shadow-xl hover:shadow-green-600/30 active:scale-[0.98]"
                    >
                      {isSubmitting ? (
                        <>
