...
const ProductionProcess: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (window.innerWidth >= 1024 && sectionRef.current && containerRef.current) {
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-white overflow-hidden lg:h-screen lg:flex lg:flex-col lg:justify-center relative">
      <div className="max-w-[1400px] mx-auto px-6 mb-16 lg:absolute lg:top-24 lg:left-0 lg:w-full lg:px-12 z-10">
      ...
      <div
        ref={containerRef}
        className="flex flex-col lg:flex-row gap-12 lg:gap-0 lg:w-max px-6 lg:px-[10vw] lg:mt-32"
      >
        {steps.map((step, index) => (
          <div
            key={index}
            className="flex flex-col lg:w-[400px] lg:flex-shrink-0 lg:pr-24 relative group"
          >
