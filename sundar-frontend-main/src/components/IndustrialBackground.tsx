...
const IndustrialBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10 bg-white">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white via-slate-50 to-green-50/40" />
      ...
      <div className="absolute top-0 right-0 w-[50vw] h-[50vh] bg-gradient-to-bl from-green-500/5 to-transparent rounded-full blur-[120px]" />
    </div>
  );
};
