  ...
  return (
    <div id="product-print-area" className="hidden print:block p-8 space-y-6">
      ...
      <div className="flex justify-between items-center border-b pb-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Sundar Corporation</h1>
      ...
      <div className="grid grid-cols-2 gap-6 pt-4">
        <div>
          ...
          <div className="mt-4 space-y-1 text-xs">
            ...
            {product.bagSize && <p><strong>Bag Size:</strong> {product.bagSize}</p>}
            {product.weight && <p><strong>Weight:</strong> {product.weight}</p>}
            {product.printType && <p><strong>Print Type:</strong> {product.printType}</p>}
