...
const TermsConditions = () => {
  ...
  const sections = [
    {
      ...
      icon: CheckCircle,
      content: 'By accessing and using Sundar Corporation website and services, you accept and agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our services.',
      points: [
  ...
  return (
    <>
      <Helmet>
        <title>Terms & Conditions - Sundar Corporation | Legal Agreement</title>
        <meta
          name="description"
          content="Terms and conditions for using Sundar Corporation website and services. Read our legal agreement before making purchases."
        />
      </Helmet>
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-[100px] lg:pb-0">
        ...
        >
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            ...
            These terms govern your use of Sundar Corporation services.
          </p>
             ...
             <div className="flex items-start gap-4">
               ...
               <div>
                 ...
                 <p className="text-gray-700 leading-relaxed font-medium">
                   ...
                   (the Data Principal) and Sundar Corporation (the Data Fiduciary). By accessing our website, placing an order, or using our
                   services, you acknowledge that you have read, understood, and agree to be bound
                   by these terms, as well as our DPDP-compliant Privacy Policy.
                 </p>
               </div>
             </div>
           </div>
          ...
          {sections.map((section, index) => {
            ...
            return (
              <ScrollReveal key={section.title} delay={index * 0.05} distance={20}>
                <div className="bg-white rounded-[2rem] shadow-lg border border-gray-200 overflow-hidden group hover:border-green-600 transition-all duration-500">
                  <div className="p-6 md:p-8">
                    <div className="flex items-start gap-4 mb-6">
                      <div className="p-4 bg-gray-100 rounded-xl group-hover:bg-green-50 transition-colors">
                        <Icon className="w-6 h-6 text-gray-700 group-hover:text-green-600 transition-colors" />
                      </div>
                      <div>
             ...
             <div className="grid md:grid-cols-2 gap-10">
               <div className="p-6 bg-white rounded-2xl border border-gray-50">
                 ...
                 <p className="text-gray-600 font-medium leading-relaxed">
                   ...
                   is the property of Sundar Corporation and protected by intellectual property laws.
                   You may not reproduce, distribute, or modify any content without our written permission.
                 </p>
               </div>
   
               <div className="p-6 bg-white rounded-2xl border border-gray-50">
                 <h4 className="font-black text-gray-800 mb-4 uppercase tracking-widest text-xs">Governing Law & Data Protection</h4>
                 <p className="text-gray-600 font-medium leading-relaxed">
                   These Terms shall be governed by and construed in accordance with the laws of India, including the Digital Personal Data Protection (DPDP) Act, 2023.
        ...
        <ScrollReveal delay={0.3} distance={40}>
           <div className="mt-12 bg-gradient-to-br from-green-600 to-green-700 rounded-[3rem] p-12 text-center text-white shadow-2xl shadow-green-600/20">
             <h3 className="text-3xl font-black mb-4 uppercase tracking-tighter">Need Clarification?</h3>
             <p className="text-green-100 mb-10 max-w-2xl mx-auto font-medium">
             ...
             <div className="flex flex-wrap justify-center gap-4">
               <a
                 ...
                 className="inline-flex items-center gap-2 px-8 py-4 bg-white text-green-600 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-slate-900 hover:text-white transition-all shadow-xl"
               >
               ...
               <a
                 href="/contact"
                 className="inline-flex items-center gap-2 px-8 py-4 bg-green-500 text-white border border-green-400 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-green-400 transition-all shadow-lg"
               >
                 Customer Support
               </a>
             </div>
